...
let playerClass = prompt ("Pick a Class: warrior or bard");
...
let hillChoice = prompt(`${userName} the ${playerClass} is heading out on a mission, a dangerous mission, where there will be many choices, and the outcome... may be DEATH. Choose wisely, young ${playerClass}. Will you go 'up the hill', or 'around it'?`);
